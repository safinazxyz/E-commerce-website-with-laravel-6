                    ...
                    <div class="widget-box">
                        ...
                        <div class="widget-content nopadding">
                            <form enctype="multipart/form-data" class="form-horizontal" method="post"
                                  ...
                                  name="add_attribute" id="add_attribute" style="text-align: left;">{{csrf_field()}}
                                ...
                                <div class="control-group">
                                    ...
                                    <label class="control-label"
                                           style="padding-left: 50px;text-align: left;"><strong>{{ $productDetails->product_color }}</strong></label>
                                </div>
                                <div class="control-group">
                                    ...
                                    <div class="field_wrapper">
                                        <div>
                                            ...
                                            <input type="text" name="price[]" id="price" placeholder="Price"
                                                   style="width: 120px;margin-left: 1px;" required/>
                                            <input type="text" name="stock[]" id="stock" placeholder="Stock"
                                                   style="width: 120px;margin-left: 2px;" required/>
                            ...
                            <div class="widget-content nopadding">
                                <form action="{{ url('admin/edit-attributes/'.$productDetails->id) }}" method="post">{{csrf_field()}}
                                    <table class="table table-bordered data-table">
                                        ...
                                        @endforeach<div style="text-align: center;padding-top: 10px;"><input class="btn btn-primary" type="submit" value="Update"></div>
                                        </tbody>
                                    </table>
