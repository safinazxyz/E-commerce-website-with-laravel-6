            ...
            <div class="quick-actions_homepage">
                <ul class="quick-actions">
                    ...
                    @if(Session::get('adminDetails')['categories_view_access']==1)
                        <li class="bg_ly"><a href="{{ url('/admin/categories') }}"> <i class="icon-inbox"></i><span
                                    class="label label-success">101</span> Categories </a></li>
                    @endif
                    @if(Session::get('adminDetails')['products_access']==1)
                        <li class="bg_lo"><a href="{{ url('/admin/products') }}"> <i class="icon-inbox"></i><span
                                    class="label label-success">101</span> Products </a></li>
                    @endif
                    @if(Session::get('adminDetails')['orders_access']==1)
                        <li class="bg_lb"><a href="{{ url('/admin/orders') }}"> <i class="icon-inbox"></i><span
                                    class="label label-success">101</span> Orders </a></li>
                    @endif
                    @if(Session::get('adminDetails')['users_access']==1)
                        <li class="bg_lr"><a href="{{ url('/admin/users') }}"> <i class="icon-inbox"></i><span
                                    class="label label-success">101</span> Users </a></li>
                    @endif
