    ...
    <div id="content">
        <div id="content-header">
            <div id="breadcrumb"><a href="index.html" title="Go to Home" class="tip-bottom"><i class="icon-home"></i>
                    Home</a> <a href="#">Admins/Sub-Admins</a> <a href="#" class="current">View Admins/Sub-Admins</a>
            </div>
                                ...
                                @foreach($admins as $admin)
                                    ...
                                    <tr class="gradeX">
                                        ...
                                        <td class="center"><a href="{{ url('/admin/edit-admin/'.$admin->id) }}" class="btn btn-primary btn-mini">Edit</a>
                                            <a rel="{{ $admin->id }}" rel1="delete-admin" <?php /* href="{{ url('/admin/delete-category/'.$pro->id) }}" */?>
