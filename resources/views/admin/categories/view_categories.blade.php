...
@section('content')
    ...
    <div id="content">
        ...
        <div style="padding-left: 20px;"><a href="{{ url('/admin/add-category/') }}" class="btn btn-primary btn-mini">Add Category</a></div>
                            ...
                            <table class="table table-bordered data-table">
                                ...
                                <tr class="gradeX">
                                    ...
                                    <td class="center"><a href="{{ url('/admin/edit-category/'.$category->id) }}" class="btn btn-primary btn-mini">Edit</a>
                                        <a rel="{{ $category->id }}" rel1="delete-category" <?php /* href="{{ url('/admin/delete-category/'.$pro->id) }}" */?>
