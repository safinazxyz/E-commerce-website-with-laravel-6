                        ...
                        <div class="widget-content nopadding">
                            <form class="form-horizontal" method="post" action="{{url('/admin/edit-category/'.$categoryDetails->id)}}" name="edit_category" id="edit_category" novalidate="novalidate">{{csrf_field()}}
                                    ...
                                    <div class="controls">
                                        <select name="parent_id" style="width: 220px;">
                                            ...
                                            @foreach($levels as $val)
                                                <option value="{{ $val->id }}" @if($val->id == $categoryDetails->parent_id)selected @endif>
                                                    {{ $val->name }}
                                                </option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <textarea name="description" id="description" class="textarea_category_description span10">{{ $categoryDetails->description }}</textarea>
                                    </div>
                                </div>
                                <div class="control-group">
