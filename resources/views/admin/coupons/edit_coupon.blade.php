                        ...
                        <div class="widget-content nopadding">
                            <form class="form-horizontal" method="post" action="{{url('/admin/edit-coupon/'.$couponDetails->id)}}"
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input value="{{ $couponDetails->coupon_code }}" type="text" name="coupon_code" id="coupon_code" minlength="5"
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input value="{{ $couponDetails->amount }}" type="text" name="amount" id="amount" min="1" required>
                                    </div>
                                </div>
                                <div class="control-group">
